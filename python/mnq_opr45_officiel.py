...
# =====================================================
CSV_PATH = "NQ10.csv"  # <-- change si besoin
...
RANGE_VS_BOX_MIN = 0.20       # (range / hauteur de box) min
WICK_OUT_MAX_FRAC = 0.70      # % max de mèche côté cassure (vs range de la bougie)
