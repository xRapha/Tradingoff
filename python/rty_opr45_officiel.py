...
# =====================================================
CSV_PATH = "RTY.csv"  # <-- change si besoin
...
TP_R = 2.65                    # Take profit en R
RETEST_MINUTES = 60           # Fenêtre de retest (strictement après la bougie de cassure)
ENABLE_BE = False             # Pas de break-even
BE_AT_R = 2.25                # (ignoré car BE off)

# Filtres sur la bougie de cassure
BODY_OUTSIDE_FRAC_MIN = 0.1  # % du corps hors box min
RANGE_VS_BOX_MIN = 0.3       # (range / hauteur de box) min
