...
# === TES PARAMS ===
TIMEFRAME = "10min"                    # "5min" | "10min" | "15min"
TP_R      = 1                         # Take Profit en R
BE_R: Optional[float] = None          # Seuil d'activation du BE (None = désactivé). Doit être < TP_R.
DAYS      = [0,1,2,3]               # 0=Lun .. 6=Dim (filtre d'étude)
WICK_MAX  = 30.0                      # % mèche max sur la bougie de cassure
INACTIVE_MONTHS: Tuple[int,...] = ()  # mois à exclure (filtre d'étude)
SIDE_MODE: Optional[str] = "short"       # None="both" | "long" | "short"
