...
TP_R = 4.75                    # TP en multiples du risque (R)
RETEST_MINUTES = 30          # fenêtre de retest (strictement après la bougie de cassure)
ENABLE_BE = False            # BE désactivé
BE_AT_R = 2.25               # (ignoré si ENABLE_BE = False)

# Filtres bougie de cassure
BODY_OUTSIDE_FRAC_MIN = 0  # OFF (0 => pas de filtre)
RANGE_VS_BOX_MIN = 0      # OFF (0 => pas de filtre)
WICK_OUT_MAX_FRAC = 0.25     # mèche côté cassure ≤ 30% du range de la bougie (0..1)
