...
# =====================================================
CSV_PATH = "ES10.csv"  # <-- change si besoin
...
TP_R = 1.5                    # Take profit en R
RETEST_MINUTES = 70           # Fenêtre de retest (strictement après la bougie de cassure)
ENABLE_BE = False             # Pas de break-even
BE_AT_R = 2.25                # (ignoré car BE off)

# Filtres sur la bougie de cassure
BODY_OUTSIDE_FRAC_MIN = 0.40  # % du corps hors box min
RANGE_VS_BOX_MIN = 0.10       # (range / hauteur de box) min
WICK_OUT_MAX_FRAC = 0.30      # % max de mèche côté cassure (vs range de la bougie)
...
BOX_FILTER_TYPE = "max"       # "max" | "min" | "band"
BOX_MAX = 60.0
BOX_MIN = 2.75
BOX_BAND_MIN = 25.0
BOX_BAND_MAX = 240.0
