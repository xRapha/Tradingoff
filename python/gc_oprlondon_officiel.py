...
# === TES PARAMS ===
TIMEFRAME = "15min"                    # "5min" | "10min" | "15min"
TP_R      = 1.5                         # Take Profit en R
BE_R: Optional[float] = None          # Seuil d'activation du BE (None = désactivé). Doit être < TP_R.
DAYS      = [0,2,4]               # 0=Lun .. 6=Dim (filtre d'étude)
WICK_MAX  = 80.0                      # % mèche max sur la bougie de cassure
INACTIVE_MONTHS: Tuple[int,...] = (1,10)  # mois à exclure (filtre d'étude)
